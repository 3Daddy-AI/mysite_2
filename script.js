...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Scroll-reactive data flow enhancement
    initDataFlowScroll();
...
function createMatrixRain() {
    ...
    const matrix = "01010101BITBIT01010101";
...
// Data Flow Scroll Effect
function initDataFlowScroll() {
    const canvas = document.createElement('canvas');
    const ctx = canvas.getContext('2d');
    canvas.style.position = 'fixed';
    canvas.style.top = '0';
    ...
    const lines = Array.from({ length: 10 }, () => new Scanline());
...
function initParticleSystem() {
    ...
    class Particle {
        constructor() {
            ...
            this.color = ['#00d2ff', '#9d50bb', '#3a7bd5', '#FFFFFF'][Math.floor(Math.random() * 4)];
        }
